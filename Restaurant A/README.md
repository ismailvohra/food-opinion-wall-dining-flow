...
The `studyid` field (currently `"restaurant-a"`) is used to namespace votes for a specific deployment or study cohort. Change it in `api.ts` to isolate your data:
